...
@pytest.fixture()
def _single_tp():
    """Single-rank TP group so parallel linear layers can be constructed."""
    import os
    ...
    if not dist.is_initialized():
        ...
        os.environ.setdefault("MASTER_PORT", "29871")
...
def test_glm51_runtime_index_cache_skips_compute_keeps_module(
    default_vllm_config, _single_tp, _stub_attn_backend
):
    buffer = torch.empty(64, 2048, dtype=torch.int32)
    # freq=4/offset=2: layers 2,3,4 skip the top-k computation
